...
public class ATMInterface extends JFrame {
    ...
    public ATMInterface() {
        ...
        balanceLabel.setFont(new Font("Tohoma",Font.PLAIN, 24));
        ...
        checkBalance.setBackground(new Color(241,8,119));
        checkBalance.setForeground(Color.WHITE);

        withdrawButton = new JButton("Withdraw");
        withdrawButton.setBounds(80,350,50,30);
        ...
        depositButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                balance += amount;
                balanceLabel.setText("Balance: Rs " + balance);
                JOptionPane.showMessageDialog(ATMInterface.this, "Deposite successful");
            }
        });
